document.addEventListener('DOMContentLoaded', function() {
    ...
    whatsappBtn.disabled = false; // WhatsApp button pehle se enabled
    ...
    whatsappBtn.addEventListener('click', function(e) {
        ...
        if (!this.disabled) {
            ...
            // 1 second بعد WhatsApp channel open کریں
            setTimeout(function() {
                window.open('https://whatsapp.com/channel/0029VaQcnPU8qIzxABCPnp35', '_blank');
